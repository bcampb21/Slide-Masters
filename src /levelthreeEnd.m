...
-(void)submitScore{ 
    GKScore *scoreReporter = [[GKScore alloc] initWithCategory:@"nkj45n6"];
...
-(IBAction)showLeaderboard:(id)sender{
    ...
    {  
        ...
        leaderboardController.category = @"nkj45n6";
...
- (void)viewDidLoad
{
    ...
    current =[[NSUserDefaults standardUserDefaults] floatForKey:@"current3"];
    ...
    int term = 0;
        ...
        int medalb =[[NSUserDefaults standardUserDefaults] integerForKey:@"levelthreebronze"];
        int medals =[[NSUserDefaults standardUserDefaults] integerForKey:@"levelthreesilver"];
        int medalg =[[NSUserDefaults standardUserDefaults] integerForKey:@"levelthreegold"];
    ...
    if (current < 12) {
        ...
        if (medal1 ==0) {
            ...
            if (didGetMedal == 0 && whichShow == 0) {
             ...
             didGetMedal = 1;
            [appDelegate levelthreebronzereward];
             [appDelegate levelthreebronze];
            whatChallenge = 1;
        }
    }
    ...
    if (current < 9.7) {
        ...
        if (medal2 ==0) {
            ...
            didGetMedal = 1;
            [appDelegate levelthreesilverreward];
            [appDelegate levelthreesilver];
            whatChallenge = 2;
        }
    }
    ...
    if (current < 8) {
        ...
        if (medal3 ==0) {
            ...
            didGetMedal = 1;
            [appDelegate levelthreegoldreward];
            [appDelegate levelthreegold];
            whatChallenge = 3;
