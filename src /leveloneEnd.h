...
@interface leveloneEnd : UIViewController <UIAlertViewDelegate,GKLeaderboardViewControllerDelegate> {
    ...
    IBOutlet UIImageView *oTopaz;
     ...
     IBOutlet UIImageView *topazTipBox;
     IBOutlet UILabel *topazText;
...
@property (nonatomic, retain)IBOutlet UILabel *topazText;
@property (nonatomic, retain)IBOutlet UIImageView *topazTipBox;
