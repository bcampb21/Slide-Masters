...
- (void)viewDidLoad
{
    ...
    step = 1;
    float highScore =[[NSUserDefaults standardUserDefaults] floatForKey:@"high9"];
    ...
    int first =[[NSUserDefaults standardUserDefaults] floatForKey:@"first9"];
