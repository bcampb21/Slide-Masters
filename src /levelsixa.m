...
#import "levelsixa.h"
#import "levelsixEnd.h"
#import "levelsix.h"

@implementation levelsixa
@synthesize slider, slider1;
...
-(void)sliders{
    ...
    if (number == 2) {
        ...
        CGRect frame1 = CGRectMake(-115, 210, 430, 59);
    ...
    if (number == 3) {
        ...
        CGRect frame1 = CGRectMake(-175, 210, 430, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 4) {
        ...
        CGRect frame1 = CGRectMake(15, 30, 290, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 5) {
        ...
        CGRect frame1 = CGRectMake(15, 100, 290, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 6) {
        ...
        CGRect frame1 = CGRectMake(15, 170, 290, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 11) {
        onScreen = 2;
        int sliderselected =[[NSUserDefaults standardUserDefaults] floatForKey:@"SliderSelected"];
        CGRect frame = CGRectMake(15, 315, 290, 59);
        slider = [[UISlider alloc] initWithFrame:frame];
        ...
        CGRect frame1 = CGRectMake(15, 380, 290, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 13) {
        onScreen = 2;
        int sliderselected =[[NSUserDefaults standardUserDefaults] floatForKey:@"SliderSelected"];
        CGRect frame = CGRectMake(-80, 230, 430, 59);
        slider = [[UISlider alloc] initWithFrame:frame];
        [slider addTarget:self action:@selector(check) forControlEvents:UIControlEventValueChanged];
        // in case the parent view draws with a custom color or gradient, use a transparent color
        slider.backgroundColor = [UIColor clearColor];
        ...
        CGRect frame1 = CGRectMake(-30, 200, 430, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 15) {
        ...
        CGRect frame1 = CGRectMake(160, 95, 145, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 16) {
        onScreen = 2;
        CGRect frame = CGRectMake(-19, 210, 430, 59);
        int sliderselected =[[NSUserDefaults standardUserDefaults] floatForKey:@"SliderSelected"];
        slider = [[UISlider alloc] initWithFrame:frame];
        [slider addTarget:self action:@selector(check) forControlEvents:UIControlEventValueChanged];
        // in case the parent view draws with a custom color or gradient, use a transparent color
        ...
        CGRect frame1 = CGRectMake(-89, 210, 430, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
...
-(void)check {
    if (type == 0 && slider.value < 4){
        ...
        if (direction == 6) {
            position = CGPointMake(-338.0f, 268.0f);
        }
        if (direction == 8) {
            position = CGPointMake(-338.0f, 428.0f);
        }
        if (direction == 10) {
            position = CGPointMake(278.0f, 800.0f);
        }
        if (direction == 11) {
            position = CGPointMake(-338.0f, 354.0f);
        }
        if (direction == 13) {
            position = CGPointMake(450.0f, 675.0f);
        }
        if (direction == 15) {
            position = CGPointMake(-338.0f, 64.0f);
        }
        if (direction == 16) {
            position = CGPointMake(200.0f, 800.0f);
        }
    ...
    if (type == 1 && slider.value > 98){
        ...
        if (direction == 2) {
            position = CGPointMake(216.0f, -222.0f);
        }
        if (direction == 5) {
            position = CGPointMake(658.0f, 340.0f);
        }
        if (direction == 7) {
            position = CGPointMake(658.0f, 340.0f);
        }
    ...
    if (direction1 == 16 && onScreen == 0) {
        slidemastersAppDelegate *appDelegate = (slidemastersAppDelegate *)[[UIApplication sharedApplication] delegate];
        [appDelegate stoplevelsixtimer];
        
        sup =[[NSUserDefaults standardUserDefaults] floatForKey:@"high6"];
        current =[[NSUserDefaults standardUserDefaults] floatForKey:@"current6"];
        
        if (sup ==0) {
            [appDelegate savehigh6];
            int gotBetterTime = 1;
        ...
        levelsixEnd *Sword = [[levelsixEnd alloc] initWithNibName:nil bundle:nil];
...
-(void)check1 {
    if (type1 == 0 && slider1.value < 4){
        ...
        if (direction1 == 4) {
            position = CGPointMake(-338.0f, 55.0f);
        }
        if (direction1 == 6) {
            position = CGPointMake(-338.0f, 166.0f);
        }
        if (direction1 == 8) {
            position = CGPointMake(-338.0f, 64.0f);
        }
        ...
        if (direction1 == 13) {
            position = CGPointMake(450.0f, 705.0f);
        }
        if (direction1 == 15) {
            position = CGPointMake(-338.0f, 120.0f);
        }
        if (direction1 == 16) {
            position = CGPointMake(150.0f, 800.0f);
        }
    ...
    if (type1 == 1 && slider1.value > 98){
        ...
        CGPoint position = CGPointMake(160.0f, 700.0f);
        if (direction1 == 2) {
            position = CGPointMake(102.0f, -220.0f);
        }
        if (direction1 == 5) {
            position = CGPointMake(658.0f, 124.0f);
        }
        if (direction1 == 7) {
            position = CGPointMake(658.0f, 124.0f);
        }
        ...
        if (direction1 == 14) {
            position = CGPointMake(216.0f, -220.0f);
        }
        slider1.center = position;
        [UIView commitAnimations];
