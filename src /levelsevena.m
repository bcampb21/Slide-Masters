...
//  Slide Masters
//
//  Created by Blake Campbell on 5/24/12.
...
-(void)sliders{
    ...
    if (number == 2) {
        onScreen = 2;
        int sliderselected =[[NSUserDefaults standardUserDefaults] floatForKey:@"SliderSelected"];
        CGRect frame = CGRectMake(-65, 307, 210, 59);
        slider = [[UISlider alloc] initWithFrame:frame];
        [slider addTarget:self action:@selector(check) forControlEvents:UIControlEventValueChanged];
        // in case the parent view draws with a custom color or gradient, use a transparent color
        slider.backgroundColor = [UIColor clearColor];
        ...
        CGRect frame1 = CGRectMake(175, 307, 210, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 3) {
        onScreen = 2;
        int sliderselected =[[NSUserDefaults standardUserDefaults] floatForKey:@"SliderSelected"];
        CGRect frame = CGRectMake(65, 200, 430, 59);
        slider = [[UISlider alloc] initWithFrame:frame];
        // in case the parent view draws with a custom color or gradient, use a transparent color
        [slider addTarget:self action:@selector(check) forControlEvents:UIControlEventValueChanged];
        slider.backgroundColor = [UIColor clearColor];
        ...
        CGRect frame1 = CGRectMake(-175, 200, 430, 59);
        slider1 = [[UISlider alloc] initWithFrame:frame1];
    ...
    if (number == 13) {
        ...
        CGRect frame = CGRectMake(15, 185, 290, 59);
        slider = [[UISlider alloc] initWithFrame:frame];
...
-(void)check{
    if (type == 0 && slider.value < 4){
        ...
        if (direction == 13) {
            position = CGPointMake(-338.0f, 211.0f);
        }
    ...
    if (direction == 13 && onScreen == 0){
        ...
        levelsevenEnd *Sword = [[levelsevenEnd alloc] initWithNibName:nil bundle:nil];
...
-(void)check1{
    if (type1 == 0 && slider1.value < 4) {
        ...
        if (direction1 == 13) {
            position = CGPointMake(-338.0f, 274.0f);
        }
