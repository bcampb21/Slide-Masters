...
- (void)viewDidLoad
{
    ...
    step = 1;
    float highScore =[[NSUserDefaults standardUserDefaults] floatForKey:@"high4"];
    ...
    int first =[[NSUserDefaults standardUserDefaults] floatForKey:@"first4"];
