...
//  Slide Masters
//
//  Created by Blake Campbell on 5/23/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import "levelseven.h"
#import "levelsevena.h"
...
- (void)viewDidLoad
{
    ...
    step = 1;
    float highScore =[[NSUserDefaults standardUserDefaults] floatForKey:@"high7"];
    ...
    int first =[[NSUserDefaults standardUserDefaults] floatForKey:@"first7"];
