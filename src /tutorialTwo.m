...
-(void)atme{
    ...
    if (time == 42) {
        [timer invalidate];
        tutSlideTwo *Sword = [[tutSlideTwo alloc] initWithNibName:nil bundle:nil];
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    int first5 = 1;
    [[NSUserDefaults standardUserDefaults] setInteger:first5 forKey:@"first5"];
