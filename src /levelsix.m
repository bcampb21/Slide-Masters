...
- (void)viewDidLoad
{
    ...
    step = 1;
    float highScore =[[NSUserDefaults standardUserDefaults] floatForKey:@"high6"];
    ...
    int first =[[NSUserDefaults standardUserDefaults] floatForKey:@"first6"];
