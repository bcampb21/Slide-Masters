...
@implementation leveleightcoundown
-(void)counting{
    mynum = mynum -1;
    ...
    if (mynum == 0) {
        ...
        leveleighta *Sword = [[leveleighta alloc] initWithNibName:nil bundle:nil];
        [self presentViewController:Sword animated:NO completion:nil];
