...
- (void)viewDidLoad
{
    ...
    step = 1;
    float highScore =[[NSUserDefaults standardUserDefaults] floatForKey:@"high8"];
    ...
    int first =[[NSUserDefaults standardUserDefaults] floatForKey:@"first8"];
